...
INSERT INTO "new_CleaningJob" ("acceptedAt", "assignedProviderId", "calendarEventId", "cancelledAt", "completedAt", "createdAt", "id", "notes", "propertyId", "scheduledDate", "startedAt", "status", "title", "updatedAt") SELECT "acceptedAt", "assignedProviderId", "calendarEventId", "cancelledAt", "completedAt", "createdAt", "id", "notes", "propertyId", "scheduledDate", "startedAt", "status", "title", "updatedAt" FROM "CleaningJob";
