...
INSERT INTO "new_CleaningJob" ("acceptedAt", "assignedProviderId", "calendarEventId", "cancelledAt", "completedAt", "createdAt", "damageFound", "id", "maintenanceNeeded", "notes", "propertyId", "restockNeeded", "scheduledDate", "startedAt", "status", "title", "updatedAt") SELECT "acceptedAt", "assignedProviderId", "calendarEventId", "cancelledAt", "completedAt", "createdAt", "damageFound", "id", "maintenanceNeeded", "notes", "propertyId", "restockNeeded", "scheduledDate", "startedAt", "status", "title", "updatedAt" FROM "CleaningJob";
